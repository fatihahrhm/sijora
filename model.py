...
data_train = pd.read_csv(
    "https://raw.githubusercontent.com/fatihahrhm/sijora/main/dataset/dataset_training_clean.csv")

factory = StopWordRemoverFactory()
stopwords = factory.get_stop_words()

corpus = pd.read_csv(
    "https://raw.githubusercontent.com/fatihahrhm/sijora/main/dataset/corpus.csv")
...
emoji = pd.read_csv(
    r'https://raw.githubusercontent.com/fatihahrhm/sijora/main/dataset/emoji.csv', encoding='utf8')
...
def fe(data):
    tfidf_trasnsformer = vectorizer.transform(
        data['Tweet'].values.astype('U')).toarray()
